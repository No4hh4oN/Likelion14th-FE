import type { AdminFinalPendingPassListResponse } from "../type";
...
type FinalPendingPassTableProps = {
  result: AdminFinalPendingPassListResponse;
  isLoading: boolean;
...
export default function FinalPendingPassTable({
  result,
  isLoading,
  hasRecruitmentId,
          ...
          {!isLoading &&
            result.items.map((item, index) => (
              ...
              >
                ...
                <td>
                  {typeof item.interviewAvgScore === "number"
                    ? item.interviewAvgScore.toFixed(1)
                    : "-"}
                </td>
              </tr>
            ))}
