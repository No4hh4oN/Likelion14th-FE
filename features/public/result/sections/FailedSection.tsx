...
const FAILED_COPY = {
  DOCUMENT: {
    ...
    message: (
      <>
        귀교생 님께서는 멋쟁이사자처럼 삼육대학교 14기 아기사자 모집에 1차{" "}
        <span className="text-[#FF6B6B]">불합격</span>하셨음을 안내드립니다.
        <br />
        본 동아리에 관심을 가지고 지원해 주셔서 진심으로 감사드립니다.
      </>
    ),
  },
  FINAL: {
    ...
    message: (
      <>
        귀교생 님께서는 멋쟁이사자처럼 삼육대학교 14기 아기사자 모집에 최종{" "}
        <span className="text-[#FF6B6B]">불합격</span>하셨음을 안내드립니다.
        <br />
...
export default function FailedSection({ stage }: FailedSectionProps) {
